...
def run_v10_clean_boost():
    print(f"\n" + "="*60)
    print(f"🚀 RUNNING V10 CLEAN BOOST: Clamp 100 + LR 1e-2 + Zero Cross-Terms")
    print("="*60)
    
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    model_name = f"dge_v10_clean_boost_{timestamp}"
    ...
    print(f"Step 2: Expanding Model (Bias=-4.0, Zero Init, Clean Cross)...")
    ...
    print(f"✅ V10 Experiment Complete. Logs in {exp_dir}")
